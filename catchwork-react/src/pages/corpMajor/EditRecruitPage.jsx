    ...
    const fetchRecruit = async () => {
      try {
        ...
        setFormData({
          ...
          recruitJobName: data.recruitJobName,
          recruitJobDetail: data.recruitJobDetail,
          recruitEdu: data.recruitEdu,
          recruitCareer: data.recruitCareer,
          recruitHeadcount: data.recruitHeadcount,
          recruitType: data.recruitType,
          recruitJobArea: data.recruitJobArea,
          recruitSalary: data.recruitSalary,
          recruitResultDate: data.recruitResultDate,
          recruitDocx: data.recruitDocx,
          recruitApply: data.recruitApply,
          recruitCorpUrl: data.recruitCorpUrl,
